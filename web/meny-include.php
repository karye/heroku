...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item"><a class="nav-link <?= ($sida == 'fill') ? 'active' : ''; ?>" href="./fill.php">Fylla tabell</a></li>
    <li class="nav-item"><a class="nav-link <?= ($sida == 'drop') ? 'active' : ''; ?>" href="./drop.php">Radera tabell</a></li>
